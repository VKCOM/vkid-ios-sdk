...
final class ImageLoader {
    typealias ImageResult = Result<(image: UIImage, url: URL), LoadingError>
    ...
    func getImage(for url: URL, completion: @escaping (ImageResult) -> Void) {
        self.lock.lock()
    ...
    func cachedImage(with request: URLRequest) -> UIImage? {
