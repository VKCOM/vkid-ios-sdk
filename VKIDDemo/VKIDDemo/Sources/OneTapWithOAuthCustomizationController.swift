...
final class OneTapWithOAuthCustomizationController: VKIDDemoViewController {
    override func viewDidLoad() {
        ...
        guard let widgetView = vkid?.ui(for: widget).uiView() else { return }
