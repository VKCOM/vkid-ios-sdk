...
public final class URLSessionTransportMock: VKAPITransport {
    public typealias TransportResult<T> = Result<T, VKAPIError>
    public typealias ResponseProvider = (
        VKAPIResponse.Type,
        VKAPIRequest
    ) -> TransportResult<VKAPIResponse>
