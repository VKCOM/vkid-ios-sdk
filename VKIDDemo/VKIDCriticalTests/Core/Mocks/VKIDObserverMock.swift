...
internal final class VKIDObserverMock: VKIDObserver {
    var didStartAuthUsing: ((VKID, OAuthProvider) -> Void)?
    var didCompleteAuthWith: ((VKID, AuthResult, OAuthProvider) -> Void?)?
    var didLogoutFrom: ((VKID, UserSession, LogoutResult) -> Void?)?
    var didRefreshAccessTokenIn: ((VKID, UserSession, TokenRefreshingResult) -> Void?)?
    var didUpdateUserIn: ((VKID, UserSession, UserFetchingResult) -> Void?)?
