...
internal struct StatEvents: VKAPINamespace {
    struct StatEventsResponse: VKAPIResponse {
        let failedIds: [Int]
    }
    ...
    struct StatEventsAddVKID: VKAPIMethod {
        typealias Response = StatEventsResponse
        typealias Parameters = StatEventsParameters
    ...
    struct StatEventsAddVKIDAnonymously: VKAPIMethod {
        typealias Response = StatEventsResponse
        typealias Parameters = StatEventsParameters
    ...
    var statEventsAddVKIDAnonymously: StatEventsAddVKIDAnonymously { Never() }
    var statEventsAddVKID: StatEventsAddVKID { Never() }
}
