...
final class LogoOnlyActivityIndicatingLayoutTests: XCTestCase {
    private let testCaseMeta = Allure.TestCase.MetaInformation(
        owner: .vkidTester,
        layer: .unit,
        product: .VKIDCore,
        feature: "Лейаут активити индикатора кнопки с лого",
        priority: .critical
    )
    enum Constants {
    ...
    override func setUpWithError() throws {
        ...
        self.testLayout = OneTapControl.LogoOnlyActivityIndicatingLayout(
            logo: self.logo,
            title: self.title,
