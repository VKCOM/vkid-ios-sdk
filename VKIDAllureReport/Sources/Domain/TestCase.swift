...
extension Allure {
    ...
    package struct TestCase {
        ...
        package var meta: MetaInformation

        package init(id: Int? = nil, name: String, meta: MetaInformation) {
            self.id = id
            self.name = name
            self.meta = meta
        }
...
extension Allure.TestCase: AllureReportable {
    package var allureReportAttributes: [AllureReportAttribute] {
...
extension Allure.TestCase {
    /// Метаинформация (дополнительная информация о тест кейсе: овнер, продукт, фича...)
    package struct MetaInformation {
        package enum Priority: String {
        ...
        package var project: Project

        package var product: Product
        package var feature: String?
        package var component: String?
...
extension Allure.TestCase {
    package enum Platform: String, AllureReportable {
...
extension Allure.TestCase {
    package enum Layer: String, AllureReportable {
        case ui
        case integration
        case unit
    }
...
extension Allure.TestCase {
    package enum Project: String, AllureReportable {
        case VKIDSDK
    }
}

extension Allure.TestCase {
    package enum Product: String, AllureReportable {
